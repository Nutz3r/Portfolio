...
$source = imagecreatefromjpeg("../images/portfolio/".$_GET['image']); // La photo est la source
...
$TailleImageChoisie = getimagesize("../images/portfolio/".$_GET['image']);
...
$rep_nom="../images/portfolio/mini_".$_GET['image'];
